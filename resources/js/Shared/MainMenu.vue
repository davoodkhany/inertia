<template>
  <div>
    <div class="mb-4">
      <inertia-link class="flex items-center py-3 group" :href="route('dashboard')">
    ...
    <div class="mb-4">
      <inertia-link class="flex items-center py-3 group" :href="route('organizations')">
    ...
    <div class="mb-4">
      <inertia-link class="flex items-center py-3 group" :href="route('contacts')">
    ...
    <div class="mb-4">
      <inertia-link class="flex items-center py-3 group" :href="route('testing')">
